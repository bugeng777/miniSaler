...
class StockPriceState:
	...
	var stock_name: String = ""     ## 股票显示名称
	var sector: String = ""         ## 股票板块
...
var garch_omega: float = 0.00001   ## 常数项
var garch_alpha: float = 0.1       ## ARCH 项系数
var garch_beta: float = 0.85       ## GARCH 项系数
